...
public class App 
{
    ...
    public static void main( String[] args ) throws NamingException
    {
        ...
        CalculadoraControllerRemote calculadoraController = (CalculadoraControllerRemote) ic.lookup("java:global/ProjetoDACEAR/ProjetoDACWeb-0.0.1-SNAPSHOT/CalculadoraController!br.edu.ifpb.dac.ejb.sessionbeans.CalculadoraControllerRemote");
