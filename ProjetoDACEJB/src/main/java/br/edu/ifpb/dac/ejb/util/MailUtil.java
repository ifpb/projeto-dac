package br.edu.ifpb.dac.ejb.util;
...
public class MailUtil {
    ...
    private static final String MAIL_NAME = "Sistema de compartilhamento de temas do TCC - IFPB";
    ...
    public void enviarEmail(String emailDestinatario, String nomeDestinatario){
        ...
        try{
            ...
            msg.setFrom(new InternetAddress(MAIL_ADRESS, MAIL_NAME));
            msg.addRecipient(Message.RecipientType.TO, new InternetAddress(emailDestinatario, nomeDestinatario));
            msg.setSubject("Confirmação de acesso a sistema de compartilhamento de temas do TCC - IFPB");
